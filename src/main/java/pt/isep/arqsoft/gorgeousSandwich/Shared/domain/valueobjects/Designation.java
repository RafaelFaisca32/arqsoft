...
public class Designation {
    ...
    public Designation(String stringValue) throws BusinessRuleViolationException {
        try {
            Validations.notNull(stringValue);
            Validations.notEmpty(stringValue);
        } catch (ValidationException e) {
            throw new BusinessRuleViolationException(String.format("Designation '%s' cannot be neither null nor empty", stringValue));
        }
